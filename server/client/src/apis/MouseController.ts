...
class MouseController {
  ...
  public slideUp(): Promise<Response> {
    const url = `${MouseController.CONTROLLER_NAME}/slide-up`;
    return fetch(url);
  }

  public slideDown(): Promise<Response> {
    const url = `${MouseController.CONTROLLER_NAME}/slide-down`;
    return fetch(url);
  }
